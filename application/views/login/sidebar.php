        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Report Pengajuan MHS</h6>
                        <a class="collapse-item" href="<?php echo base_url()?>Passing/profile/search#!<?php echo hash('sha256',$_SESSION['user'])?>">MAGANG</a>
                        <a class="collapse-item" href="<?php echo base_url()?>Passing/profile/search#!<?php echo hash('sha256',$_SESSION['user'])?>">PKL</a>
                        <a class="collapse-item" href="<?php echo base_url()?>Passing/profile/search#!<?php echo hash('sha256',$_SESSION['user'])?>">SKRIPSI</a>
                    </div>
                </div>
            </li>
