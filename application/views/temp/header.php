    ...
    <body>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end" id="sidebar-wrapper">
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3" href="<?php echo base_url()?>Source_in_out/outdataallberkas/<?php echo $_SESSION['user'] ?>/REQUEST/request#!<?php echo hash('sha256',$_SESSION['user'])?>">Request Berkas <text class="text-danger"><?php echo $mail;?></text></a>
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="<?php echo base_url()?>Passing/datakemahasiswaan/kemahasiswaan/kemahasiswaan#!<?php echo hash('sha256',$_SESSION['user'])?>">Kemahasiswaan Prodi</a>
